...
class scanning_path:
    def __init__(self):
        ...
        # self._load_trajectory(os.path.join(sys.path[0],'../trajectory/aco.txt'))
    ...
    def _create_trajectory(self):
        ...
        self._create_updownpath([-2,2],[-19.5,-6],0.4,-0.5*pi,0.5,-0.5*pi)
        self._create_updownpath([-8,8],[-6,-1.5],0.4,-0.5*pi,0.5,-0.5*pi)
        ...
        self._create_cylinder_path(0,-20.5,3.0,[1,2])
        self._create_intermediate(-10,-26,0.5,0.5*pi)
